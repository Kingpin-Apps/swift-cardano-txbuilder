...
public extension TxBuilder.Transactions {
    ...
    /// Create a transaction that registers a stake address using the Conway Register Certificate.
    /// - Parameters:
    ...
    func unregister(
        ...
        let unregisterCertificate = Unregister(
        ...
        self.txBuilder.certificates = [
            .unregister(unregisterCertificate)
        ]
