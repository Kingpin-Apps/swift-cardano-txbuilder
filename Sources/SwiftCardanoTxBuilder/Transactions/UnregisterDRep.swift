...
public extension TxBuilder.Transactions {
    ...
    /// Unregisters a DRep on the blockchain.
    /// - Parameters:
    ///   - drepCredential: The DRep credential to unregister.
    ...
    func unregisterDRep(
        ...
        let unRegisterDRepCertificate = UnregisterDRep(
            drepCredential: drepCredential,
        ...
        self.txBuilder.certificates = [
            .unRegisterDRep(unRegisterDRepCertificate)
        ]
